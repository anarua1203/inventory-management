...
# Restocking orders submitted through the API. Unlike the datasets above, this
# list is not backed by a JSON file: it lives in memory only and resets on restart.
restock_orders = []
